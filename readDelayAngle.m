...
fileForResults = "SpotfiResults.txt";
...
if ~isfile(directory+fileForResults)
    ...
    fprintf(fileID,"ant\tseed\tpacketNum\tpacketPerSpec\tbandwidth\tdecimation" + col + "\n");
    fclose(fileID);
end
...
%                                 data_dir = "run_cluster/results/music/music_"+string(seed);
                                ...
                                if isfile(file)
                                    ...
                                    if SpotfiMeasurement
                                        ...
                                        for_print = string(ant)+"\t"+string(seed)+"\t"+string(p)+"\t"+string(perSpec)+"\t"+string(band)+"\t"+string(dec);
